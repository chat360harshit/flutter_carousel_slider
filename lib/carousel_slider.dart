...
import 'carousel_controller.dart' as car;
...
class CarouselSlider extends StatefulWidget {
  ...
  final car.CarouselControllerImpl _carouselController;
  ...
  CarouselSlider(
      ...
      this.disableGesture,
      car.CarouselController? carouselController,
      Key? key})
      : itemBuilder = null,
        itemCount = items != null ? items.length : 0,
        _carouselController = carouselController != null
            ? carouselController as car.CarouselControllerImpl
            : car.CarouselController() as car.CarouselControllerImpl,
        super(key: key);
...
class CarouselSliderState extends State<CarouselSlider>
  ...
  final car.CarouselControllerImpl carouselController;
  Timer? timer;
